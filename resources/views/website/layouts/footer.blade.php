        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center sm:text-left">
            ...
            <div class="flex flex-col items-center sm:items-start">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('website.services') }}" class="hover:text-purple-400 transition">Services</a></li>
                    <li><a href="{{ route('website.blogs') }}" class="hover:text-purple-400 transition">Blogs</a></li>
                    <li><a href="{{ route('website.jobs') }}" class="hover:text-purple-400 transition">Jobs</a></li>
                    <li><a href="{{ route('website.contacts') }}" class="hover:text-purple-400 transition">Contact</a></li>
                </ul>
            </div>
