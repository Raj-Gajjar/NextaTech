    ...
    <div class="container mx-auto flex justify-between items-center py-3 px-6">
        ...
        <nav id="menu" class="hidden md:flex md:items-center md:space-x-4">
            <a href="<?php echo e(route('home')); ?>"
               ...
               <?php echo e(request()->routeIs('home') ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white' : ''); ?>">
                <i class="bi bi-house me-2"></i> Home
            </a>
            <a href="<?php echo e(route('website.services')); ?>"
               class="flex items-center px-4 py-2 text-gray-300 hover:bg-gradient-to-r from-purple-500 to-blue-500 hover:text-white rounded transition
               <?php echo e(request()->routeIs('website.services') ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white' : ''); ?>">
                <i class="bi bi-gear me-2"></i> Services
            </a>
            <a href="<?php echo e(route('website.blogs')); ?>"
               class="flex items-center px-4 py-2 text-gray-300 hover:bg-gradient-to-r from-purple-500 to-blue-500 hover:text-white rounded transition
               <?php echo e(request()->routeIs('website.blogs') ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white' : ''); ?>">
                <i class="bi bi-journal-text me-2"></i> Blogs
            </a>
            <a href="<?php echo e(route('website.jobs')); ?>"
               class="flex items-center px-4 py-2 text-gray-300 hover:bg-gradient-to-r from-purple-500 to-blue-500 hover:text-white rounded transition
               <?php echo e(request()->routeIs('website.jobs') ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white' : ''); ?>">
                <i class="bi bi-briefcase me-2"></i> Jobs
            </a>
            <a href="<?php echo e(route('website.contacts')); ?>"
               class="flex items-center px-4 py-2 text-gray-300 hover:bg-gradient-to-r from-purple-500 to-blue-500 hover:text-white rounded transition
               <?php echo e(request()->routeIs('website.contacts') ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white' : ''); ?>">
...
<?php /**PATH D:\xampp\htdocs\compufy-admin-panel\resources\views/website/layouts/header.blade.php ENDPATH**/ ?>