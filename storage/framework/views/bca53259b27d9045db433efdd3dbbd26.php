...
<section class="text-center mb-20 px-4 sm:px-6 lg:px-10 pt-10">
    ...
    <div class="flex justify-center space-x-4 flex-wrap">
        ...
        <a href="<?php echo e(route('website.contacts')); ?>" 
    ...
    <section>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            ...
            <div class="bg-white shadow-md rounded-lg p-6 flex items-center justify-center hover:shadow-xl hover:-translate-y-1 transition transform">
                <img src="<?php echo e(asset('storage/'.$client->logo)); ?>" alt="Client Logo" class="max-h-16 object-contain">
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
...
<section class="mb-20 px-4 sm:px-6 lg:px-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-xl hover:-translate-y-1 transition transform">
            ...
            <img src="<?php echo e(asset('storage/'.$blog->image)); ?>" alt="<?php echo e($blog->title); ?>" class="w-full h-48 object-cover">
...
<section>
        ...
        <div class="space-y-4">
            ...
            ?>
            <div class="bg-white shadow-md rounded-lg p-6 flex flex-col sm:flex-row sm:justify-between sm:items-center hover:shadow-xl hover:-translate-y-1 transition transform border-t-4 border-transparent hover:border-t-4 hover:border-<?php echo e($gradient); ?>">
                <div class="mb-4 sm:mb-0">
                    <h3 class="text-xl font-semibold text-gray-800"><?php echo e($job->title); ?></h3>
                    <p class="text-gray-600 mt-1"><?php echo e($job->location); ?></p>
                </div>
                <a href="/jobs/<?php echo e($job->id); ?>" class="px-6 py-3 rounded-md bg-gradient-to-r <?php echo e($gradient); ?> text-white font-semibold text-center hover:opacity-90 transition whitespace-nowrap">Apply</a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
...
<?php echo $__env->make('website.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\compufy-admin-panel\resources\views/website/home.blade.php ENDPATH**/ ?>